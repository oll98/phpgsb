	...
	function saveChunks($processeddata,$listname)
		{
		  ...
		  if($indexins)
			...
			mysql_query("INSERT INTO `$listname-s-hosts` (`ID`,`Hostkey`,`Chunknum`,`Count`) VALUES $hostinsert;");
			...
			mysql_query("INSERT INTO `$listname-s-prefixes` (`ID`,`Hostkey`,`AddChunkNum`,`Prefix`) VALUES $pairinsert;");
		  ...
		  if($indexins)
			...
			//Insert hostkeys index
			$hostinsert = implode(', ',$buildhost);
			mysql_query("INSERT INTO `$listname-a-hosts` (`ID`,`Hostkey`,`Chunknum`,`Count`) VALUES $hostinsert;");
			...
			//Insert prefixes
			$pairinsert = implode(', ',$buildpairs);
			mysql_query("INSERT INTO `$listname-a-prefixes` (`ID`,`Hostkey`,`Prefix`) VALUES $pairinsert;");
